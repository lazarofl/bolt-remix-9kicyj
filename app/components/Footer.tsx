  ...
  return (
    <footer className="bg-white dark:bg-gray-950" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="space-y-8">
            <div>
              <Link to="/" className="inline-block">
                <span className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent dark:from-white dark:to-gray-300">
                  Squadds
                </span>
              </Link>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 dark:border-gray-100/10">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Squadds, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
